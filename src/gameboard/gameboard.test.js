...
//   expect(gameboard.placeShip(shipB, 'horizontal', ['F', 6])).toBe(
//     'Ship position overlaps another'
//   );
// });
...
test('Occupy 2D array', () => {
  ...
  gameboard.placeShip(shipA, 'vertical', ['A', 3]); //['A', 3], ['A', 4], ['A', 5], ['A', 6], ['A', 7]
  ...
  gameboard.placeShip(shipA, 'vertical', ['G', 6]); //['G', 6, ['G', 7], ['G', 8], ['G', 9], ['G', 10]
  expect(gameboard.gridsArray).toEqual([
    [],
    [],
    [],
  ...
  gameboard.placeShip(shipA, 'horizontal', ['C', 3]); //['C', 3, ['D', 3], ['E', 3], ['F', 3], ['G', 3]
  expect(gameboard.gridsArray).toEqual([
    [],
    [],
    [],
